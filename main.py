...
from app.agent.langchain_orchestrator import AgenticComplianceOrchestrator

app = FastAPI(title="Agentic Compliance AI Server")

orchestrator = AgenticComplianceOrchestrator()
...
def audit_policy(request: PolicyRequest):
    """Audit a compliance policy using the agentic orchestrator."""
